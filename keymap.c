...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, /*...*/ KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
        KC_HOME, KC_PGDN, KC_PGUP, KC_END, LT(3,KC_TAB), KC_SPC, LT(1,KC_ESC), /*...*/ LT(2,KC_BSPC), LSFT_T(KC_ENT), LT(1,KC_DEL),  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
    [1] = LAYOUT(
